...
TEST_CASE("context_window_for_model returns correct sizes", "[BudgetTracker]") {
    SECTION("xAI Grok models") {
        ...
        CHECK(context_window_for_model("grok-4.7")               ==   500'000);
        CHECK(context_window_for_model("grok-4.6")               ==   500'000);
    ...
    SECTION("Anthropic Claude models") {
        ...
        CHECK(context_window_for_model("claude-opus-5")          == 1'000'000);
    ...
    SECTION("Kimi / Moonshot models") {
        ...
        CHECK(context_window_for_model("k3-256k")               ==   262'144);
